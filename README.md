...
def main():
    ...
    print("\nMerging into a single combined file...")
    combined_size = merge_all()# Mainstreams EPG
...
if __name__ == "__main__":
    main()
[README.md](https://github.com/user-attachments/files/31356657/README.md)
...
[README.md](https://github.com/user-attachments/files/31356661/README.md)
